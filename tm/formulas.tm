...
<\body>
  ...
  <\equation*>
    <stack|<tformat|<table|<row|<cell|<dfrac||<around*|\<llbracket\>|N|\<rrbracket\>><rsup|<with|color|red|\<Gamma\>>><rsub|ecmaify>=<with|font-series|bold|Thunk><around*|(|\<Gamma\>,N<rprime|'>|)>><choice|<tformat|<table|<row|<cell|N.type=<math-tt|LazyFunctionDeclaration>>>|<row|<cell|N<around*|[|<math-tt|content>|]>=N<rprime|'>>>>>>>|<cell|>>|<row|<cell|>|<cell|>>|<row|<cell|>|<cell|>>|<row|<cell|>|<cell|>>|<row|<cell|<frac|\<Gamma\>\<vdash\>N:<math-tt|FunctionDeclaration><space|2em><around*|\<llbracket\>|N|\<rrbracket\>><rsup|\<Gamma\>><rsub|ecmaify>=E|\<Sigma\>\<triangleright\><with|font-series|bold|Thunk><around*|(|\<Gamma\>,N|)>\<longrightarrow\>\<Sigma\>\<triangleright\>E>>|<cell|>>|<row|<cell|>|<cell|>>|<row|<cell|<frac|\<Gamma\>\<vdash\>N:\<bot\>|\<Sigma\>\<triangleright\><with|font-series|bold|Thunk><around*|(|\<Gamma\>,N|)>\<longrightarrow\>\<Sigma\>\<triangleright\>\<bot\><rsub|<math-tt|DelayedSyntaxError>>>>|<cell|>>|<row|<cell|>|<cell|>>|<row|<cell|>|<cell|>>|<row|<cell|>|<cell|>>|<row|<cell|>|<cell|>>|<row|<cell|>|<cell|>>|<row|<cell|<stack|<tformat|<table|<row|<cell|<dfrac||<around*|\<llbracket\>|N|\<rrbracket\>><rsup|<with|color|red|\<Gamma\>>><rsub|ecmaify>=<with|font-series|bold|Thunk><around*|(|\<Gamma\>,N<rprime|'>,T|)>><choice|<tformat|<table|<row|<cell|<math-ss|Skippable>\<in\>N.attributes>>|<row|<cell|N<around*|[|<math-tt|content>|]>=N<rprime|'>>>|<row|<cell|N.type<around*|[|<math-tt|content>|]>.type=T>>>>>>|<cell|>>|<row|<cell|>|<cell|>>|<row|<cell|>|<cell|>>|<row|<cell|>|<cell|>>|<row|<cell|<frac|\<Gamma\>\<vdash\>N:T<space|2em><around*|\<llbracket\>|N|\<rrbracket\>><rsup|\<Gamma\>><rsub|ecmaify>=E|\<Sigma\>\<triangleright\><with|font-series|bold|Thunk><around*|(|\<Gamma\>,N,T|)>\<longrightarrow\>\<Sigma\>\<triangleright\>E>>|<cell|>>|<row|<cell|>|<cell|>>|<row|<cell|<frac|\<Gamma\>\<vdash\>N:T<rprime|'>|\<Sigma\>\<triangleright\><with|font-series|bold|Thunk><around*|(|\<Gamma\>,N,T|)>\<longrightarrow\>\<Sigma\>\<triangleright\>\<bot\><rsub|<math-tt|DelayedSyntaxError>>><choice|<tformat|<table|<row|<cell|T<rprime|'>\<neq\>T>>>>>>|<cell|>>>>>>|<cell|>>>>>
  </equation*>
